						...
						<div class="box-body">
							...
							<form id="loginEmail_from">
								...
								<div class="form-group text-right" >
									<button type="button"  id="loginEmail_Btn" class="btn btn-primary btn-block">点击登录</button>
								</div>
								...
								<div class="title-line">
              					...
              					<a href="login.jsp" class="btn btn-social btn-block facebook"><!--<i class="ion-social-facebook"></i> -->使用邮箱账号登录</a>
							</form>
						</div>
					</div>
				</div>
		...
		<script>
			$("#loginEmail_Btn").click(function () {
				...
				if($('input[name="email"]').val()==""||$('input[name="password"]').val()==""){
					...
					$.ajax({
						"url":"loginEmail.do",
						"data":$("#loginEmail_from").serialize(),
						"type":"POST",
						"dataType":"json",
